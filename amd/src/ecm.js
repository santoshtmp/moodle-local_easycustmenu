...
export const admin_setting_init = () => {
   ...
   */
    ...
    */
    ...
    var show_menu_label = 'Show Default "User menu items" ';
    var hide_menu_label = 'Hide Default "User menu items" ';
    if (document.querySelector("#admin-customusermenuitems > .form-setting ")) {
        ...
        document.querySelector("#admin-customusermenuitems > .form-setting ").prepend(get_ecm_btn('#', show_menu_label, 'show_hide_customusermenuitems show_menu'));
        ...
        var element_show_hide = document.querySelector("#admin-customusermenuitems > .form-setting a.show_hide_customusermenuitems");
        element_show_hide.addEventListener("click", function (e) {
            e.stopPropagation();
            e.preventDefault();
            if (element_show_hide.classList.contains("show_menu")) {
